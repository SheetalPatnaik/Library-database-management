...
def bookRegister():
    ...
    status = status.lower()
    Number_of_Copies=bookInfo5.get()
    
    insertBooks = "insert into "+bookTable+" values('"+bid+"','"+title+"','"+author+"','"+status+"','"+Number_of_Copies+"')"
    try:
...
def addBook(): 
    ...
    #Book count
    lb5 = Label(labelFrame,text="Number_of_Copies : ", bg='black', fg='white')
